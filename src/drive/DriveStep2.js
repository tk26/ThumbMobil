...
export default class DriveStep2 extends Component {
    constructor(props) {
        super(props);
    ...
    validate() {
        ...
        // validation success
        this.props.navigation.navigate('DriveStep3', {
            drive: {
                startLocation: this.props.navigation.state.params.drive.startLocation,
                endLocation: this.props.navigation.state.params.drive.endLocation,
                availableSeats: this.props.navigation.state.params.drive.availableSeats,
